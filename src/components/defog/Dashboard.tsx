...
export function Dashboard() {
  ...
  if (showArchive) {
    return (
      <div className={`min-h-screen ${fontClass}`} style={{ backgroundColor: colors.bg }}>
        <header className="sticky top-[52px] z-20" style={{ backgroundColor: colors.bgCard, borderBottom: `1px solid ${colors.border}` }}>
  ...
  return (
    <div className={`min-h-screen flex flex-col ${fontClass}`} style={{ backgroundColor: colors.bg, overflowX: 'clip' }}>
      ...
      <header className="sticky top-[52px] z-20 backdrop-blur-md shadow-lg shadow-black/30 mx-2 sm:mx-4 mt-2 rounded-xl" style={{ backgroundColor: `${colors.bgCard}dd`, border: `1px solid ${colors.border}` }}>
